...
function acceptBooking(_x3, _x4) {
  return _acceptBooking.apply(this, arguments);
}
function _acceptBooking() {
  _acceptBooking = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, booking, petOwner;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          ...
          _context3.next = 7;
          return PetOwner.findByPk(booking.petOwnerId);
        case 7:
          petOwner = _context3.sent;
          if (booking) {
            _context3.next = 10;
            break;
          }
...
function rejectBooking(_x5, _x6) {
  return _rejectBooking.apply(this, arguments);
}
function _rejectBooking() {
  _rejectBooking = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var id, reasonForRejecting, booking;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          id = req.params.id;
          reasonForRejecting = req.body.reasonForRejecting;
